...
## Dedicated WHIP hostname support

HoboStreamer can advertise a dedicated WHIP ingestion origin such as `https://whip.hobostreamer.com`, but this requires explicit deployment support:
